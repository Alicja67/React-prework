...
// import { getColumnsForList } from './columnsRedux';

// selectors
export const getCardsForColumn = ({cards}, columnId) => cards.filter((card) => card.columnId == columnId);
export const getCardsForSearching = ({cards}, searchString) => cards.filter(card => new RegExp(searchString, 'i').test(card.title));
...
export default function reducer(statePart = [], action = {}) {
  switch (action.type) {
    ...
    case MOVE_CARD: {
      ...
      // console.log(targetCard, targetColumnCards, src);
